(() => {
  ...
  function injectBridge(html, audioUrl, title, part) {
    ...
    const layoutFix = '<style id="ielts-embedded-layout-fix">html{margin:0!important;padding:0!important;min-height:0!important;height:auto!important;scroll-behavior:auto!important;overflow:auto!important}body{display:block!important;align-items:initial!important;justify-content:initial!important;margin:0!important;padding:14px 18px 80px!important;min-height:0!important;height:auto!important;box-sizing:border-box!important;background:#fff!important;overflow:auto!important}body>*,main,#app,.app,.container,.wrapper,.page,.content,.exam,.test,.question-container{min-height:0!important;height:auto!important;max-height:none!important;margin-top:0!important;padding-top:0!important;transform:none!important;position:relative!important;top:auto!important}header:empty,.spacer:empty,[class*="spacer"]:empty,[class*="hero"]:empty{display:none!important}audio{max-width:100%!important}input,textarea,select,[contenteditable="true"]{scroll-margin-top:90px!important}@media(max-width:1100px){body{padding:10px 10px 64px!important;width:100%!important;max-width:100%!important}table{max-width:100%!important}}</style>';
